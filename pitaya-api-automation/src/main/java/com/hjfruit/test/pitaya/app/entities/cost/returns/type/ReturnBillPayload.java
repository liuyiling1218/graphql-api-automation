package com.hjfruit.test.pitaya.app.entities.cost.returns.type;
import lombok.Data;
...
@AllArgsConstructor
@NoArgsConstructor
public class ReturnBillPayload{
    /**
     * 
     */
     ...
     * 
     */
    private PurchaseReturnTypeEnum returnType;
    /**
     * 
     */
     ...
     * 
     */
    private List<BillAuditDetailPayload> billAuditDetailRespList;
    /**
     * 
     */
    private ReturnsCommodityBillPayload returnsCommodityBillResp;
    /**
     * 
     */
    private ReturnsOtherBillPayload returnsOtherBillResp;
}