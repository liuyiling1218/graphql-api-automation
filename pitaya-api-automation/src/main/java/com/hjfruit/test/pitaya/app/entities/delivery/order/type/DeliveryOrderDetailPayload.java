package com.hjfruit.test.pitaya.app.entities.delivery.order.type;
import lombok.Data;
...
public class DeliveryOrderDetailPayload{
     ...
     * 
     */
    private DeliveryOrderStatusEnum orderStatus;
    /**
     * 
     */
     ...
     * 
     */
    private List<DeliveryOrderFeePayload> deliveryOrderFee;
    /**
     * 
     */
    private List<DeliveryOrderItemPayload> deliveryOrderItem;
}