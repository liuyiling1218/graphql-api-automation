 ...
 * 
 */
public enum AllBusinessType{
DEFAULT,PRODUCTION_IN_APPLY,RAW_PURCHASE,RAW_RETURN,SEMI_FINISHED_IN_APPLY,DEFECTIVE_IN_APPLY,SUB_PURCHASE,SUB_RETURN,CHECK_IN_APPLY,OTHER_IN_APPLY,TURNOVER_BASKET_RETURN,SALES_RETURN,RETURNED_GOODS_RETURN,SEMI_FINISHED_PRODUCTS_RETURN,TRANSFER_IN_APPLY,RAW_MATERIAL_ACQUISITION,SUPPLEMENTARY_MATERIAL_ACQUISITION,RETURNED_GOODS_OUT,FINISHED_PRODUCT_ACQUISITION,SEMI_FINISHED_PRODUCT_ACQUISITION,OTHER_ACQUISITION,DAMAGED_ACQUISITION,CHECK_ACQUISITION,DEFECTIVE_SALE,PURCHASE_RETURN,TRANSFER_OUT_APPLY,DAMAGED_RAW_MATERIAL,DAMAGED_SEMI_FINISHED_PRODUCT,DAMAGED_RETURNED_GOODS,DAMAGED_PRODUCTION,CREATE_MANUALLY,CREATE_AUTOMATICALLY,REALTIME_STOCK,SECONDED,COMMODITY_CONVERT,TASK_MONITOR,IN_STOCK_RECORD,OUT_STOCK_RECORD}