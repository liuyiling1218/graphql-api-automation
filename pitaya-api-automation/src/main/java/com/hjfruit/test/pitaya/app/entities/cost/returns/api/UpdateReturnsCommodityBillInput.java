package com.hjfruit.test.pitaya.app.entities.cost.returns.api;
import lombok.Data;
...
@AllArgsConstructor
@NoArgsConstructor
public class UpdateReturnsCommodityBillInput{
    /**
     * 
     */
    @Needed 
     ...
     * 
     */
    private List<UpdateCommodityItemInput> updateReturnsCommodityItemReqList;
}