package com.hjfruit.test.pitaya.app.apis.saleincome.api;
...
public interface SaleIncomeApi {
    @GraphqlQuery("")
    PageSaleIncomeOrderPayload pageSaleIncomeOrder(PageSaleIncomeOrderInput pageSaleIncomeOrderInput,Page page);
    @GraphqlQuery("")
    SaleIncomeOrderPayload getSaleIncomeOrder(GetSaleIncomeInput input);
    @GraphqlQuery("")
    SaleIncomeOrderStatisticPayload saleIncomeOrderStatistic();
    @GraphqlQuery("")
    SaleIncomeOrderStatusStatisticPayload saleIncomeOrderStatusStatistic(SaleIncomeOrderStatusStatisticInput saleIncomeOrderStatusStatisticInput);
    @GraphqlMutation("")
    Boolean updateSaleIncomeOrder(UpdateSaleIncomeOrderInput updateSaleIncomeOrderInput);
    @GraphqlMutation("")
    Boolean submitSaleIncomeOrder(SubmitSaleIncomeOrderInput submitSaleIncomeOrderInput);
    @GraphqlMutation("")
    Boolean auditSaleIncomeOrder(AuditSaleIncomeOrderInput auditSaleIncomeOrderInput);
    @GraphqlMutation("")
    Boolean rejectSaleIncomeOrder(RejectSaleIncomeOrderInput rejectSaleIncomeOrderInput);
}