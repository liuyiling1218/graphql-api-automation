package com.hjfruit.test.pitaya.app.entities.delivery.order.api;
import lombok.Data;
...
@AllArgsConstructor
@NoArgsConstructor
public class UpdateDeliveryOrderInput{
    /**
     * 
     */
    @Needed 
    ...
    @Needed 
    @NotEmpty 
    private List<DeliveryOrderFeeInput> deliveryOrderFee;
    /**
     * 
     */
    @Needed 
    @NotEmpty 
    private List<DeliveryOrderItemInput> deliveryOrderItem;
}