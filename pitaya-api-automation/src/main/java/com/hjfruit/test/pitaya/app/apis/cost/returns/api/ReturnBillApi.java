package com.hjfruit.test.pitaya.app.apis.cost.returns.api;
...
public interface ReturnBillApi {
    @GraphqlQuery("")
    PageReturnBillPayload pageReturnsBill(PageReturnsBillInput pageReturnsBillInput,Page page);
    @GraphqlQuery("")
    ReturnBillPayload getReturnsBillDetail(GetReturnsBillDetailInput getReturnsBillDetailInput);
    @GraphqlQuery("")
    StatusGroupCountPayload statusGroupCount(StatusGroupCountInput statusGroupCountInput);
    @GraphqlMutation("")
    Boolean updateReturnsCommodityBill(UpdateReturnsCommodityBillInput updateReturnsCommodityBillInput);
    @GraphqlMutation("")
    Boolean updateReturnsOtherBill(UpdateReturnsOtherBillInput updateReturnsOtherBillInput);
    @GraphqlMutation("")
    Boolean submitReturnsBill(UpdateReturnsBillStatusInput updateReturnsBillStatusInput);
    @GraphqlMutation("")
    Boolean rejectReturnsBill(UpdateReturnsBillStatusInput updateReturnsBillStatusInput);
    @GraphqlMutation("")
    Boolean acceptReturnsBill(UpdateReturnsBillStatusInput updateReturnsBillStatusInput);
}