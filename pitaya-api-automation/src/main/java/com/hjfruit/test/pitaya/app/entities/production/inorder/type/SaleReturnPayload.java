package com.hjfruit.test.pitaya.app.entities.production.inorder.type;
import lombok.Data;
...
@AllArgsConstructor
@NoArgsConstructor
public class SaleReturnPayload{
    /**
     * 
     */
    private Integer countInBounds;
    /**
     * 
     */
     ...
     * 
     */
    private InOrderType inOrderType;
    /**
     * 
     */
     ...
     * 
     */
    private InOrderStatus inOrderStatus;
    /**
     * 
     */
     ...
     * 
     */
    private List<SaleReturnCommoditiesItemPayload> commodities;
}