package com.hjfruit.test.pitaya.app.entities.cost.common;
import lombok.Data;
...
UNRECOGNIZED,BILL_UN_CONFIRMED,BILL_UN_SUBMITTED,BILL_BIZ_UN_REVIEWED,BILL_FD_UN_REVIEWED,BILL_COMPLETE,ERROR_BILL_STATUS}