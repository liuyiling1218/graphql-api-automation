package com.hjfruit.test.pitaya.app.entities.production.outorder.type;
import lombok.Data;
...
FLOW_RETURNS_STATUS_ERROR,UNRECOGNIZED,FLOW_RETURNS_STATUS_WAIT_SUBMIT,FLOW_RETURNS_STATUS_WAIT_PROCESSED,FLOW_RETURNS_STATUS_COMPLETED,FLOW_RETURNS_STATUS_CANCEL}