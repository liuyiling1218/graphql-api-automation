package com.hjfruit.test.pitaya.app.entities.saleincome.api;
import lombok.Data;
...
@AllArgsConstructor
@NoArgsConstructor
public class AuditSaleIncomeOrderInput{
    /**
     * 
     */
    @Needed 
     ...
     * 
     */
    private List<SaleCostOrderItemInput> saleCostOrderItems;
    /**
     * 
     */
    private List<SaleIncomeOrderInput> saleIncomeOrderItems;
}