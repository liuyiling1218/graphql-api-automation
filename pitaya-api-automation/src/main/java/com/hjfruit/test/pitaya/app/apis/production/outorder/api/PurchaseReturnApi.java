package com.hjfruit.test.pitaya.app.apis.production.outorder.api;
...
public interface PurchaseReturnApi {
    @GraphqlMutation("")
    PurchaseReturnInsertPayload createPurchaseReturn(PurchaseReturnInsertInput purchaseReturnInsertInput);
    @GraphqlMutation("")
    Boolean updatePurchaseReturn(UpdatePurchaseReturnInput updatePurchaseReturnInput);
    @GraphqlMutation("")
    Boolean cancelPurchaseReturnOrder(CancelPurchaseReturnOrderInput cancelPurchaseReturnOrderInput);
    @GraphqlMutation("")
    Boolean submitPurchaseReturnOrder(SubmitPurchaseReturnOrderInput submitPurchaseReturnOrderInput);
    @GraphqlQuery("")
    List<CommoditySkuStock> purchaseReturnCommodities(PurchaseReturnCommoditiesInput purchaseReturnCommoditiesInput);
    @GraphqlQuery("")
    PagePurchaseReturnPayload pagePurchaseReturn(PagePurchaseReturnInput pagePurchaseReturnInput,Page page);
    @GraphqlQuery("")
    PurchaseReturnPayload getPurchaseReturn(GetPurchaseReturnInput getPurchaseReturnInput);
    @GraphqlQuery("")
    ReturnStatusStatisticPayload returnStatusStatistic(ReturnStatusStatisticInput returnStatusStatisticInput);
}