package com.hjfruit.test.pitaya.app.entities.production.outorder.api;
import lombok.Data;
...
@AllArgsConstructor
@NoArgsConstructor
public class UpdatePurchaseReturnInput{
    /**
     * 
     */
    @Needed 
     ...
     */
    @Needed 
    private List<PurchaseReturnCommodityInput> commodityList;
    /**
     * 
     */
    private List<ReturnOtherInput> returnOtherList;
}