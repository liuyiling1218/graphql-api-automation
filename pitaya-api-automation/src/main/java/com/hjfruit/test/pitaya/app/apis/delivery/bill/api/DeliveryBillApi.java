package com.hjfruit.test.pitaya.app.apis.delivery.bill.api;
...
public interface DeliveryBillApi {
    @GraphqlQuery("")
    PageDeliveryBillPayload pageDeliveryBill(PageDeliveryBillInput pageDeliveryBillInput,Page page);
    @GraphqlQuery("")
    DeliveryBillPayload getDeliveryBill(GetDeliveryBillInput getDeliveryBillInput);
    @GraphqlQuery("")
    DeliveryBillStatusCountPayload deliveryBillStatusCount();
    @GraphqlQuery("")
    List<StringOption> deliveryBillDeliveryMethod();
    @GraphqlQuery("")
    List<StringOption> deliveryBillType();
    @GraphqlQuery("")
    List<StringOption> deliveryBillPayMode();
    @GraphqlMutation("")
    Boolean updateDeliveryBillFee(UpdateDeliveryBillFeeInput updateDeliveryBillFeeInput);
    @GraphqlMutation("")
    Boolean submitDeliveryBillFee(UpdateDeliveryBillStatusInput updateDeliveryBillStatusInput);
    @GraphqlMutation("")
    Boolean rejectDeliveryBillFee(UpdateDeliveryBillStatusInput updateDeliveryBillStatusInput);
    @GraphqlMutation("")
    Boolean auditDeliveryBillFee(UpdateDeliveryBillStatusInput updateDeliveryBillStatusInput);
}