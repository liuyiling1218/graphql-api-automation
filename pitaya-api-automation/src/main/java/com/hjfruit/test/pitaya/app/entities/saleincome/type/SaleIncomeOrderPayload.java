package com.hjfruit.test.pitaya.app.entities.saleincome.type;
import lombok.Data;
...
@AllArgsConstructor
@NoArgsConstructor
public class SaleIncomeOrderPayload{
    /**
     * 
     */
     ...
     * 
     */
    private SaleIncomeSourceType sourceType;
    /**
     * 
     */
     ...
     * 
     */
    private List<SaleIncomeOrderItemPayload> commoditiesList;
    /**
     * 
     */
    private List<SaleCostOrderItemPayload> saleCostOrderItems;
    /**
     * 
     */
    private List<SaleIncomeOrderLogPayload> logs;
    /**
     * 
     */
    private String saleCostOrderId;
    /**
     * 
     */
    private FunctionalField functionalField;
}