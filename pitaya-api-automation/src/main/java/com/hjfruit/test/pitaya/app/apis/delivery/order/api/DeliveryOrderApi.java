package com.hjfruit.test.pitaya.app.apis.delivery.order.api;
...
public interface DeliveryOrderApi {
    @GraphqlQuery("")
    PageDeliveryOrderPayload pageDeliveryOrder(DeliveryOrderQueryInput deliveryOrderQueryInput,Page page);
    @GraphqlQuery("")
    DeliveryOrderDetailPayload deliveryOrderDetail(DeliveryOrderDetailQueryInput deliveryOrderDetailQueryInput);
    @GraphqlQuery("")
    DeliveryOrderStatusCountPayload deliveryOrderStatusCount();
    @GraphqlQuery("")
    List<SaleGoodsInfoListPayload> querySaleGoodsList(SaleGoodsListQueryInput saleGoodsListQueryInput);
    @GraphqlMutation("")
    String addDeliveryOrder(AddDeliveryOrderInput addDeliveryOrderInput);
    @GraphqlMutation("")
    Boolean updateDeliveryOrder(UpdateDeliveryOrderInput updateDeliveryOrderInput);
    @GraphqlMutation("")
    Boolean submitDeliveryOrder(SubmitDeliveryOrderInput submitDeliveryOrderInput);
    @GraphqlMutation("")
    Boolean cancelDeliveryOrder(CancelDeliveryOrderInput cancelDeliveryOrderInput);
}