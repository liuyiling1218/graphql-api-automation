package com.hjfruit.test.pitaya.app.apis.production.inorder.api;
...
public interface SaleReturnApi {
    @GraphqlMutation("")
    SaleReturnInsertPayload createSaleReturn(SaleReturnInsertInput saleReturnInsertInput);
    @GraphqlMutation("")
    Boolean updateSaleReturn(SaleReturnUpdateInput saleReturnUpdateInput);
    @GraphqlMutation("")
    Boolean cancelSaleReturn(SaleReturnCancelInput saleReturnCancelInput);
    @GraphqlMutation("")
    Boolean submitSaleReturn(SaleReturnSubmitInput saleReturnSubmitInput);
    @GraphqlQuery("")
    List<ListSaleReturnCommoditiesPayload> listSaleReturnCommodities(ListSaleReturnCommoditiesInput listSaleReturnCommoditiesInput);
    @GraphqlQuery("")
    SaleReturnPagePayload pageSaleReturn(PageSaleReturnInput pageSaleReturnInput,Page page);
    @GraphqlQuery("")
    CountSaleReturnPayload countSaleReturn(CountSaleReturnInput countSaleReturnInput);
    @GraphqlQuery("")
    SaleReturnPayload getSaleReturn(GetSaleReturnInput getSaleReturnInput);
    @GraphqlQuery("")
